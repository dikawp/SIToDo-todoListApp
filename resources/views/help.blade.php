    ...
    <div class="container py-5">
        <div class="row">
            <div class="project-content-pl col-12 col-lg-6 d-flex flex-column">
                ...
                <h5>Thank you for choosing our to-do list app as your productivity partner. Send us questions and your experience using the website that can make us continue to develop to make your experience with our application even more enjoyable.</h5>
            </div>
